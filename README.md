...
<a href="https://www.mediafire.com/file/tbxjofrju32lspd/UNIVO.apk/file">
  <img src="https://img.shields.io/badge/📱%20Android-Download%20APK-34A853?style=for-the-badge&logo=android&logoColor=white" alt="Download UNIVO for Android">
</a>
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=flutter,dart,typescript,nodejs,express,supabase,postgres,vercel,github&perline=9" alt="UNIVO technology stack">
</div>
...
```mermaid
flowchart TD
    A["UNIVO<br/>Student Platform"] --> B["Website / PWA"]
    A --> C["Android App"]
    B --> D["UNIVO API<br/>Node.js · Express · TypeScript"]
    C --> D
    D --> E[("Database")]
    D --> F[("Storage")]
    D --> G["Authentication"]
...
<img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=18&duration=3000&pause=1200&color=0B63CE&center=true&vCenter=true&width=650&lines=Building+the+future+of+student+life.;One+student+at+a+time.;One+community+at+a+time.;From+Zambia+to+the+world." alt="UNIVO vision animation">
